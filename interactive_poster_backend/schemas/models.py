...
class SectionBase(BaseModel):
    ...
    image_urls: Optional[List[str]] = Field(default_factory=list) # Renamed from section_images
...
class SectionUpdate(BaseModel):
    ...
    section_content: Optional[str] = None
    image_urls: Optional[List[str]] = None # Renamed from section_images, allows replacing or clearing
...
class OriginalLLMPromptRequest(BaseModel):
    ...
    selected_theme: Optional[str] = None
    style_overrides: Optional[PosterElementStyles] = None
    is_direct_update: Optional[bool] = Field(default=False)
    sections: Optional[List[SectionCreate]] = None # New field for full section replacement
